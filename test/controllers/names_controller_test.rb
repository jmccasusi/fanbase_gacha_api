...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { gacha_conifgs: @name.gacha_conifgs, is_private: @name.is_private } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { gacha_conifgs: @name.gacha_conifgs, is_private: @name.is_private } }, as: :json
    assert_response 200
  end
